...
exports.deleteBusinessHandler = exports.updateBusinessHandler = exports.getBusinessHandler = exports.getBusinessesHandler = void 0;
...
exports.updateBusinessHandler = (0, utils_1.catchAsync)(async (req, res) => {
    if (typeof req.params['businessId'] === 'string') {
        const business = await businessService.updateBusinessById(new mongoose_1.default.Types.ObjectId(req.params['businessId']), req.body);
        res.send((0, SuccessResponse_1.default)({ business }));
    }
});
