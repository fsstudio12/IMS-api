...
const reformPermissions_1 = __importDefault(require("../../modules/utils/reformPermissions"));
const router = express_1.default.Router();
router
    .route('/')
    .get((0, auth_1.auth)((0, reformPermissions_1.default)({
    [resources_1.default.EMPLOYEES]: [actions_1.default.EDIT],
})), (0, validate_1.validate)(employee_1.employeeValidation.getEmployeesSchema), employee_1.employeeController.getEmployeesHandler)
    .post((0, auth_1.auth)(), employee_1.employeeController.createEmployeeHandler);
router
    .route('/:employeeId')
    .get((0, auth_1.auth)(), (0, validate_1.validate)(employee_1.employeeValidation.getEmployeeSchema), employee_1.employeeController.getEmployeeHandler)
    .patch((0, auth_1.auth)(), employee_1.employeeController.updateEmployeeHandler)
    .delete((0, auth_1.auth)(), (0, validate_1.validate)(employee_1.employeeValidation.deleteEmployeeSchema), employee_1.employeeController.deleteEmployeeHandler);
